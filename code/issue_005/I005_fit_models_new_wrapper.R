...
I005_fit_models_new_wrapper = function(participant_id,
                                  starting_values,
                                  algorithm,
                                  xtol_rel,
                                  maxeval,
  ...
  source(file.path(base_path, 'code', 'issue_005', 'I005_fit_models_new.R'))
...
I005_fit_models_new_wrapper(participant_id = opt$participant_id,
...
# Rscript I005_fit_models_new_wrapper --participant_id '1NU6KP5' --starting_values 'random' --algorithm 'NLOPT_GN_DIRECT_L' --xtol_rel 0.00001 --maxeval 100 --iterations 1
