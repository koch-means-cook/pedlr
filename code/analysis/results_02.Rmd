...
# Left bandit
# Younger
b_left_ya = t.test(data_rw_beta[group == 'younger']$V2,
       mu = 0)
# Older
b_left_oa = t.test(data_rw_beta[group == 'older']$V2,
       mu = 0)
...
# Right bandit
# Younger
b_right_ya = t.test(data_rw_beta[group == 'younger']$V1,
       mu = 0)
# Older
b_right_oa = t.test(data_rw_beta[group == 'older']$V1,
       mu = 0)
...
# Left bandit
c_b_left = cor.test(data_rw_beta$V2,
                    data_rw_beta$perc_correct_1v2)

# Right bandit
c_b_right = cor.test(data_rw_beta$V1,
                     data_rw_beta$perc_correct_1v2)
...
knitr::kable(test_model_comp_rw) %>%
  kableExtra::kable_styling()
```
...
**$\chi^2$-test of dichotomized $u-l$-values**
