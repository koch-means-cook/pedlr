...
data_corr = all_designs %>%
  ...
  data.table::dcast(., participant_id + task_version ~ comp, value.var = 'perc_correct')
bla = data.table::merge.data.table(data, data_corr, by = c('participant_id', 'task_version'))
```
