...
cols = c('participant_id', 'model', 'run', 'trial', 'option_left', 
         'option_right', 'reward_stim_1', 'reward_stim_2', 'trial_type',
...
```{r}
# GET CORRECT_CHOICE COLUMN ON PREDICTED DATA
# DO WINDORIZE ANALYSIS ==> DOES IT SHOW THE SAME THINGS AS OUR PARTICIPANTS?
