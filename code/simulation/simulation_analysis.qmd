...
p = ggplot(data = data_avg_surprise[!l == u,],
...
p = ggplot(data = data_avg_unc,
  ...
  scale_y_continuous(limits = c(0.7, 0.95),
                     breaks = c(0.7, 0.95)) +
  facet_grid(alpha~pi, labeller = label_both)
p
```
...
p = ggplot(data = data_avg_sep,
  ...
  scale_y_continuous(limits = c(0.7, 0.95),
                     breaks = c(0.7, 0.95)) +
  facet_grid(alpha_pos~alpha_neg, labeller = label_both)
p
```
